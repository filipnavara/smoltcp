...
FEATURES_TEST=(
    ...
    "std,medium-ethernet,proto-ipv4,proto-ipv6,socket-tcp,socket-udp,proto-ipv6-slaac,proto-ipv6-rio"
    ...
    "std,medium-ieee802154,proto-sixlowpan,proto-ipv6-rio,socket-udp,auto-icmp-echo-reply"
...
FEATURES_CHECK=(
    ...
    "medium-ip,medium-ethernet,medium-ieee802154,proto-ipv6,proto-ipv6-slaac,proto-ipv6-rio,multicast,proto-dhcpv4,proto-ipsec,socket-raw,socket-udp,socket-tcp,socket-icmp,socket-dns,async"
    ...
    "defmt,medium-ip,medium-ethernet,proto-ipv6,proto-ipv6-slaac,proto-ipv6-rio,multicast,proto-dhcpv4,socket-raw,socket-udp,socket-tcp,socket-icmp,socket-dns,async"
    ...
    "defmt,alloc,medium-ip,medium-ethernet,proto-ipv6,proto-ipv6-slaac,proto-ipv6-rio,multicast,proto-dhcpv4,socket-raw,socket-udp,socket-tcp,socket-icmp,socket-dns,async"
    "medium-ieee802154,proto-sixlowpan,socket-dns,auto-icmp-echo-reply"
    "medium-ieee802154,proto-sixlowpan,proto-ipv6-rio,socket-dns,auto-icmp-echo-reply"
)
...
clippy() {
    ...
    cargo +$MSRV clippy --tests --features proto-ipv6-rio -- -D warnings
}
